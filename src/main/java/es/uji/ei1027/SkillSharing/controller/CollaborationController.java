...
public class CollaborationController {
    ...
    public class OfferController {
        ...
        @RequestMapping(value="/delete/{idRequest,idOffer}")
        public String processDelete(@PathVariable Integer idRequest,@PathVariable Integer idOffer){
            collaborationDao.deleteCollaboration(collaborationDao.getCollaboration(idRequest,idOffer));
